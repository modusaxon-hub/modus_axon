...
## Architectural rules
* **Prioridad Mobile-First**: Todo componente debe ser diseñado primero para móviles.
* **Áreas Táctiles (Touch Targets)**: Todo elemento interactivo (botones, enlaces, inputs) debe tener un área de interacción mínima de **44x44px** para asegurar usabilidad táctil.
